  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className={`absolute inset-0 bg-gradient-to-br transition-colors duration-1000 ${isDarkMode ? 'from-black/70 via-black/40 to-black/80' : 'from-white/50 via-transparent to-white/30'}`}></div>
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl w-full">
        <div className="mb-6 opacity-0 animate-reveal">
           <span className="text-gold uppercase tracking-[0.3em] md:tracking-[0.6em] text-[9px] md:text-sm font-bold block bg-white/5 backdrop-blur-md px-4 md:px-6 py-2 rounded-full inline-block border border-white/20">
            A Arte de Celebrar
          </span>
        </div>
        
        <h1 className={`text-5xl md:text-9xl font-bold mb-6 md:mb-10 leading-[1.1] md:leading-tight opacity-0 animate-reveal stagger-1 drop-shadow-2xl transition-colors duration-1000 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
          Essência & <br />
